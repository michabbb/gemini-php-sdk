...
final class GenerateContentResponse implements ResponseContract
{
     ...
     *                 fileData: ?array{ fileData: string, mimeType: string, fileName: string }
     *             }>,
     *             role: string
     *         },
     *         finishReason: string,
     *         safetyRatings: array<array{ category: string, probability: string, blocked: ?bool }>,
     *         citationMetadata: ?array{ citationSources: array<array{ startIndex: int, endIndex: int, uri: string, license: string }> },
     *         index: int,
     *         tokenCount?: int|null,
     *         avgLogprobs?: float|null
     *     }>,
    ...
    public static function from(array $attributes): self
    {
        ...
        $usageMetadata = isset($attributes['usageMetadata']) ? UsageMetadata::from($attributes['usageMetadata']) : null;
